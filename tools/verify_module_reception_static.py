...
def main() -> int:
    ...
    reading_assistant_markers = {
        ...
        "DOCUMENT_READING_ASSISTANT_INTERACTIVE_WORKBENCH": "DOCUMENT_READING_ASSISTANT_INTERACTIVE_WORKBENCH",
        "DOCUMENT_READING_IMAGE_SELECTION_PANEL": "DOCUMENT_READING_IMAGE_SELECTION_PANEL",
        "DOCUMENT_READING_PROFILE_SELECTOR": "DOCUMENT_READING_PROFILE_SELECTOR",
        "READING_LAYER_MANUAL_DRAFT_EDITOR": "READING_LAYER_MANUAL_DRAFT_EDITOR",
        "OTTOMAN_GLOSSARY_INTERACTIVE_BUILDER": "OTTOMAN_GLOSSARY_INTERACTIVE_BUILDER",
        "SOURCE_IMAGE_TEXT_COMPARISON_WORKBENCH": "SOURCE_IMAGE_TEXT_COMPARISON_WORKBENCH",
        "ARABIC_TRANSLATION_DRAFT_EDITOR": "ARABIC_TRANSLATION_DRAFT_EDITOR",
        "REVIEWER_DECISION_AND_CONFIDENCE_PANEL": "REVIEWER_DECISION_AND_CONFIDENCE_PANEL",
        "NO_FILE_UPLOAD_BACKEND_IN_WORKBENCH": "NO_FILE_UPLOAD_BACKEND_IN_WORKBENCH",
        "NO_REAL_OCR_ENGINE_IN_WORKBENCH": "NO_REAL_OCR_ENGINE_IN_WORKBENCH",
        "NO_REAL_HTR_ENGINE_IN_WORKBENCH": "NO_REAL_HTR_ENGINE_IN_WORKBENCH",
        "NO_REAL_TRANSLATION_ENGINE_IN_WORKBENCH": "NO_REAL_TRANSLATION_ENGINE_IN_WORKBENCH",
        "DRAFT_ONLY_INTERACTIVE_READING_OUTPUT": "DRAFT_ONLY_INTERACTIVE_READING_OUTPUT",
        "HUMAN_APPROVAL_REQUIRED_FOR_WORKBENCH_TEXT": "HUMAN_APPROVAL_REQUIRED_FOR_WORKBENCH_TEXT",
    ...
    print("DOCUMENT_READING_ASSISTANT_INTERACTIVE_WORKBENCH=PASS")
    print("DOCUMENT_READING_IMAGE_SELECTION_PANEL=PASS")
    print("DOCUMENT_READING_PROFILE_SELECTOR=PASS")
    print("READING_LAYER_MANUAL_DRAFT_EDITOR=PASS")
    print("OTTOMAN_GLOSSARY_INTERACTIVE_BUILDER=PASS")
    print("SOURCE_IMAGE_TEXT_COMPARISON_WORKBENCH=PASS")
    print("ARABIC_TRANSLATION_DRAFT_EDITOR=PASS")
    print("REVIEWER_DECISION_AND_CONFIDENCE_PANEL=PASS")
    print("NO_FILE_UPLOAD_BACKEND_IN_WORKBENCH=PASS")
    print("NO_REAL_OCR_ENGINE_IN_WORKBENCH=PASS")
    print("NO_REAL_HTR_ENGINE_IN_WORKBENCH=PASS")
    print("NO_REAL_TRANSLATION_ENGINE_IN_WORKBENCH=PASS")
    print("DRAFT_ONLY_INTERACTIVE_READING_OUTPUT=PASS")
    print("HUMAN_APPROVAL_REQUIRED_FOR_WORKBENCH_TEXT=PASS")
